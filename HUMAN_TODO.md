...
| # | Action | Reference |
|---|--------|-----------|
| 5 | ☐ **Reserve `vouchfx` and `Platform.Sdk` on NuGet.org** and provision `NUGET_API_KEY` in the repo secrets — after item 2 confirms the name. | GTM-02 · [#84](https://github.com/tomas-rampas/vouchfx/issues/84) |
...
| # | Action | Reference |
|---|--------|-----------|
| 11 | ☐ **Cut the `v1.0.0` tag.** The 2026-07-05 smoke run proved the pipeline end-to-end (all build/sign jobs green); needs items 4 and 5 first — and formally item 8. | GTM-01/05 · [#121](https://github.com/tomas-rampas/vouchfx/issues/121) |
