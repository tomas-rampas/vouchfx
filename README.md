...
- **[vouchfx-mcp](https://github.com/tomas-rampas/vouchfx-mcp)** — Model Context Protocol (MCP) server for AI-assisted test authoring (in active development, not yet published as a tool). ([source](https://github.com/tomas-rampas/vouchfx-mcp))
