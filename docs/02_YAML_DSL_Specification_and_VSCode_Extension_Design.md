...
**Two limits of the client half, both worth knowing before you design your PKI.** The two-tier support described above is a statement about the **server** direction, and a mutual-TLS reader will reasonably try to apply it in both. It does not carry over.
