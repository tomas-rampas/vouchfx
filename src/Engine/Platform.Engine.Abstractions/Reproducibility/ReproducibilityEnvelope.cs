// Platform.Engine.Abstractions — ReproducibilityEnvelope (S05-B-03, §17, docs/02 §3.2.2).
//
...
//   • Pure BCL only — Platform.Engine.Abstractions is a leaf library that
...
//   Platform.Engine.Orchestration — Abstractions cannot reference Orchestration
...
namespace Platform.Engine.Abstractions.Reproducibility;
