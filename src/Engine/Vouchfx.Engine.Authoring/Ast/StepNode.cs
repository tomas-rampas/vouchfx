// Vouchfx.Engine.Authoring — StepNode AST record (S03-B-02).
//
...
namespace Vouchfx.Engine.Authoring.Ast;
...
/// (<see cref="Vouchfx.Sdk.CaptureExpr"/>, carrying both the query language —
...
/// <see cref="Vouchfx.Engine.Abstractions.VerifyMode.Immediate"/> when the
...
/// <see cref="Vouchfx.Engine.Abstractions.VerifyMode.Retry"/> steps this
