// Vouchfx.Engine.Compilation — AssemblyClosure (§5.6).
//
...
///     that declare types under the reserved namespaces <c>Vouchfx.Engine.*</c> or
///     <c>Vouchfx.Steps.*</c> (S02-F-03).
///   </description></item>
///   <item><description>
...
public static class AssemblyClosure
{
    ...
    ///     refuses customer DLLs that squat on <c>Vouchfx.Engine.*</c> or
    ///     <c>Vouchfx.Steps.*</c>.  Assemblies in the trusted set (built by
    ...
    /// <c>Vouchfx.Engine.*</c> or <c>Vouchfx.Steps.*</c> — when <em>both</em>
    /// conditions hold:
    /// </para>
    /// <list type="number">
    ///   <item><description>
    ///     Its simple name starts with <c>Vouchfx.Engine.</c> or
    ///     <c>Vouchfx.Steps.</c>, or equals <c>Vouchfx.Sdk</c>.
    ///   </description></item>
    ///   <item><description>
    ...
    ///     <c>Vouchfx.Engine.Evil</c> that lives outside the engine directory is NOT
    ...
    internal static HashSet<string> BuildTrustedSimpleNames(IReadOnlyList<Assembly> list)
    {
        ...
        foreach (var assembly in list)
        {
            ...
            // Step 1 — name must carry a reserved prefix or equal Vouchfx.Sdk.
            var hasReservedPrefix =
                name.StartsWith("Vouchfx.Engine.", StringComparison.Ordinal) ||
                name.StartsWith("Vouchfx.Steps.", StringComparison.Ordinal) ||
                name.Equals("Vouchfx.Sdk", StringComparison.Ordinal);
