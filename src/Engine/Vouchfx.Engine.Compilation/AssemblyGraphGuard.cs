// Vouchfx.Engine.Compilation — AssemblyGraphGuard (§5.6).
//
...
/// <remarks>
/// <para>
/// Reserved namespaces: <c>Vouchfx.Engine.*</c> (engine) and
/// <c>Vouchfx.Steps.*</c> (providers).  Customer DLLs declaring these namespaces
