// Platform.Steps.MailExpect.Smtp — mail-expect.smtp step provider (DSL §5, §13).
//
      ...
      IStepDiffRenderer
{
    ...
    private static readonly IReadOnlyList<string> s_helpers = new[]
    {
        ...
        "        Platform.Engine.Abstractions.Verdict verdict = Platform.Engine.Abstractions.Verdict.EnvironmentError;\n" +
