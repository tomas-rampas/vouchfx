// Platform.Steps.MqExpect.AzureServiceBus — mq-expect.azureservicebus step provider (DSL §5, §13).
//
...
namespace Platform.Steps.MqExpect.AzureServiceBus;
      ...
      ICompileReferenceContributor
{
    ...
    private static readonly IReadOnlyList<string> s_helpers = new[]
    {
        ...
        "            verdict = matched ? Platform.Engine.Abstractions.Verdict.Pass : Platform.Engine.Abstractions.Verdict.Fail;\n" +
