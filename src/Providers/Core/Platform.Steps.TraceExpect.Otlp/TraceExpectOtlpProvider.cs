// Platform.Steps.TraceExpect.Otlp — trace-expect.otlp step provider (DSL §5.10, Phase C, §13).
//
...
/// <see cref="Platform.Engine.Abstractions.StepOutcome"/> into <c>Vars</c> for the runner to
      ...
      IStepDiffRenderer
{
    ...
    private static readonly IReadOnlyList<string> s_usings = new[]
    {
        ...
        "Platform.Engine.Abstractions.Traces",
    };
    ...
    private const string HelperSource = """
        static class TraceExpectOtlp_Helpers
        {
            ...
            public static async System.Threading.Tasks.Task AssertAsync(
                ...
                Platform.Engine.Abstractions.Traces.ITraceCaptureAccessor traces,
                string outcomeKey,
                ...
                string[] captureKinds)
            {
                ...
                try
                {
                    ...
                    Platform.Engine.Abstractions.Traces.CapturedSpan? matchedSpan = null;
    ...
    /// and writes a typed <see cref="Platform.Engine.Abstractions.StepOutcome"/> into
