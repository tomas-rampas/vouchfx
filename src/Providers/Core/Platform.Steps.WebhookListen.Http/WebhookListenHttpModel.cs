// Platform.Steps.WebhookListen.Http — webhook-listen.http step model (DSL §5, §13).
...
/// <see cref="Platform.Engine.Abstractions.Verdict.Fail"/> when no captured request matches
