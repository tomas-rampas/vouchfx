// Platform.Steps.WebhookListen.Http — webhook-listen.http step provider (DSL §5, §13).
//
...
namespace Platform.Steps.WebhookListen.Http;
...
/// criteria, and writes a typed <see cref="Platform.Engine.Abstractions.StepOutcome"/> into
...
/// non-match yields <see cref="Platform.Engine.Abstractions.Verdict.Fail"/>, and the
/// engine-owned RetryRunner re-invokes the delegate and converts a sustained Fail to
/// <see cref="Platform.Engine.Abstractions.Verdict.Inconclusive"/> on timeout.  The helper
      ...
      IHostResourceContributor<WebhookListenHttpModel>
{
    ...
    private static readonly IReadOnlyList<string> s_usings =
        new[]
        {
            ...
            "Platform.Engine.Abstractions.Webhooks",
        };
    ...
    private static readonly IReadOnlyList<string> s_helpers = new[]
    {
        ...
        "        Platform.Engine.Abstractions.Webhooks.IWebhookCaptureAccessor webhooks,\n" +
        "        string outcomeKey,\n" +
        ...
        "        Platform.Engine.Abstractions.Webhooks.CapturedWebhookRequest request,\n" +
        "        string? method,\n" +
        "        string? path,\n" +
        "        string? bodyContains,\n" +
        "        string[] headerNames,\n" +
    ...
    /// <see cref="Platform.Engine.Abstractions.StepOutcome"/> into
    ...
    /// <see cref="Platform.Engine.Abstractions.Verdict.EnvironmentError"/> and no secret value
