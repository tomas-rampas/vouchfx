// Vouchfx.Steps.Http.Soap — http.soap step provider (DSL §5.1, second http-family provider, §13).
//
// REUSES Vouchfx.Steps.Core.HttpRest's patterns throughout (per the task brief): Target+Path
