// Platform.Sdk.Testing — StepRunResult.
//
    ...
    IReadOnlyList<string> ValidationErrors)
{
    ...
    /// (<see cref="Verdict"/> equals <see cref="Platform.Engine.Abstractions.Verdict.Pass"/>).
    /// </summary>
    public bool IsPass => Verdict == Platform.Engine.Abstractions.Verdict.Pass;
}
