...
//     ENTIRELY in the test assembly — the frozen Platform.Sdk surface is not
//     touched.
...
// ── A brand-new OPTIONAL extension interface, declared here, not in Platform.Sdk ──
...
/// optional surfaces WITHOUT mutating any frozen v1 interface in Platform.Sdk.
/// </summary>
...
public sealed class OptionalExtensionInterfaceTests
{
    ...
    /// <summary>
    /// The new optional interface lives in the TEST assembly, not in Platform.Sdk:
