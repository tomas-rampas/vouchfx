// Tests for DbAssertPostgresProvider's IStepDiffRenderer implementation (S07-G-01).
//
...
/// <see cref="DbAssertPostgresProvider"/>.
/// </summary>
public sealed class DbAssertPostgresDiffRendererTests
{
