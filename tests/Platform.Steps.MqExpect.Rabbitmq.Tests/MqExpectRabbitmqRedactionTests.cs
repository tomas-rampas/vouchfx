// §17 credential-redaction regression tests for MqExpectRabbitmqProvider (non-docker).
//
// Directly exercises the emitted MqExpectRabbitmq_Helpers.RedactAmqpUri method by
...
/// <c>MqExpectRabbitmq_Helpers.RedactAmqpUri</c> method.
/// </summary>
public sealed class MqExpectRabbitmqRedactionTests
{
    ...
    public async Task RedactAmqpUri_WithCraftedMessageContainingSecret_SecretIsStripped()
    {
        ...
        var fragment = provider.Emit(GetModel(), new StubCompileContext("redact-direct"));
    ...
    public async Task RedactAmqpUri_UserinfoBareHost_IsStripped()
    {
        ...
        var provider = new MqExpectRabbitmqProvider();
        var fragment = provider.Emit(GetModel(), new StubCompileContext("redact-bare-host"));
    ...
    public async Task RedactAmqpUri_MessageWithoutUri_ReturnedUnchanged()
    {
        ...
        var provider = new MqExpectRabbitmqProvider();
        var fragment = provider.Emit(GetModel(), new StubCompileContext("redact-no-uri"));
