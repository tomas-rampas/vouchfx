// Vouchfx.Engine.Compilation.MemoryHarness — entry point (S01-B-03 / S02-B-01, §5).
//
...
//
// Usage:
//   dotnet run -c Release --project tests/Vouchfx.Engine.Compilation.MemoryHarness
//   dotnet run -c Release --project tests/Vouchfx.Engine.Compilation.MemoryHarness \
...
using Vouchfx.Engine.Compilation.MemoryHarness;
