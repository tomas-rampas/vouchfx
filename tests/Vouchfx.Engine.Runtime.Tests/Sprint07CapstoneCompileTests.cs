...
//
// Why this lives in Vouchfx.Engine.Runtime.Tests (and not the Orchestration test
// project): ProviderPipeline, PipelineResult, ResourcePlanEntry, and HostResourcePlan are
// INTERNAL to Vouchfx.Engine.Runtime and visible here via InternalsVisibleTo
// (Vouchfx.Engine.Runtime.csproj → Vouchfx.Engine.Runtime.Tests).  The docker capstone
