// Tests for DbAssertSqlServerProvider's IStepDiffRenderer implementation (S07-G-01).
//
...
/// <see cref="DbAssertSqlServerProvider"/>.
/// </summary>
public sealed class DbAssertSqlServerDiffRendererTests
{
