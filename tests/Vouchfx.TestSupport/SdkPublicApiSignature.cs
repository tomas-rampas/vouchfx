...
// freeze gate (SdkContractFreezeTests over Vouchfx.Sdk; SdkTestingContractFreezeTests
// over Vouchfx.Sdk.Testing).  Extracted verbatim from the original copy that lived
// inside tests/Vouchfx.Sdk.Tests/SdkContractFreezeTests.cs so that both goldens are
...
public static class SdkPublicApiSignature
{
    ...
    /// accurately via its own title: the <c>Vouchfx.Sdk</c> golden passes the FROZEN v1
    /// provider-contract title; the <c>Vouchfx.Sdk.Testing</c> golden passes its own
